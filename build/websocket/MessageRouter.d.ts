...
export declare class MessageRouter {
    ...
    private handleObjectsList;
    private handleObjectsGet;
    private handleStatesGet;
    private handleAliasesInspect;
    private handleRoomsList;
    private handleInstancesList;
    private handleAdapterStatus;
    private collectStateIds;
    private applyStateValues;
    private sendBridgeResponse;
    private getPayloadString;
    private getPayloadIds;
    private pickStates;
    private toAliasInspection;
